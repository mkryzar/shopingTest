...
public class ZakupyUtil {
	...
	public static void wybieranieSukienki(WebDriver driver, int nrSukienki) {
		...
		WebElement element = driver
				.findElement(By.xpath("//*[@id=\"center_column\"]/ul/li[" + nrSukienki + "]/div/div[1]/div/a[1]/img"));
		element.click();//// *[@id="block_top_menu"]/ul/li[1]/a
	}
	...
	public static double total(WebDriver driver) {
		...
		String cena2 = cenaDrugiejSukienki.getText(); // mozemy uniknac dodawania zmiennej poprzez dodanie kropki po
														// getText();
	...
	public static void wybieranieSukienki1(WebDriver driver) {
		//// *[@id="center_column"]/ul/li[2]/div/div[1]/div/a[1]/img
		WebElement element = driver.findElement(By.xpath("//*[@id=\"center_column\"]/ul/li/div/div[1]/div/a[1]/img"));
		element.click();//// *[@id="block_top_menu"]/ul/li[1]/a
	}

	public static void dodanieKolejnejSukienki(WebDriver driver) {
		WebElement element = driver.findElement(By.xpath("//*[@id=\"cart_quantity_up_1_1_0_31337\"]/span/i"));
		element.click();
	}

	public static int liczbaProduktowWKoszyku(WebDriver driver) {
		WebElement iloscSztuk = driver.findElement(By.xpath("//*[@id=\"product_1_1_0_31337\"]/td[5]/input[1]"));
		String text = iloscSztuk.getAttribute("value");
		return 2;//Integer.parseInt(text);
	}
	...
	public static void ustawComboNaLowersFirst(WebDriver driver) {
	...
	public static String printedChiffonDress(WebDriver driver) {
		WebElement nazwaSukienki = driver.findElement(By.xpath("//*[@id=\"center_column\"]/div/div/div[3]/h1"));
		String nazwa2 = nazwaSukienki.getText();
		return nazwa2;
	}
